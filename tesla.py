...
for x in jsondata["Results"]:
  ...
  if (  x["Model_Name"] ==  "Model 3"  ):
      res = x 
      print ( "DING DING DING  MODEL 3 = model id", x["Model_ID"] )
      break

print ( "dong dong dong   MODEL 3 = model id", str(res)  )
